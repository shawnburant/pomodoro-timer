...
- **Task list** — tracks named tasks across sessions; add tasks manually with the `+` button before starting work; see total pomodoro count per task; inline checkbox to mark/unmark complete; × button to delete; collapsible completed section
