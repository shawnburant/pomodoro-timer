...
- **Task list** — tracks named tasks across sessions; see total pomodoro count per task; inline checkbox to mark/unmark complete; × button to delete; collapsible completed section
